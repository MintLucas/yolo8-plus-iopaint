...
from agi_server.camera_classify.camera_server_help import Camera_Server_help
import traceback
...
@app.post(path="/process_image_local", response_model=ApiResponse, summary="图片多标签理解")
...
if __name__ == '__main__':
    ...
    uvicorn.run(app='camera_main_server_14548:app', host='0.0.0.0', port=14548, workers=3)